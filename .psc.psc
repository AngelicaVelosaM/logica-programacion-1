Algoritmo ComparaciónNúmeros
		...
		Escribir "Digita el tercer número"
		Leer num3
		...
		SiNo
			...
			Escribir "Los números ordenados de menor a mayor son: ", numMenor, " ", numMedio, " ", numMayor
			Escribir "Los números ordenados de mayor a menor son: ", numMayor, " ", numMedio, " ", numMenor
		FinSi
